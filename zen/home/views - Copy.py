...
def session(request):
    ...
    face_classifier = cv2.CascadeClassifier(r'C:\Users\HP\Desktop\Emotion_Detection_CNN - Copy\haarcascade_frontalface_default.xml')
    classifier =load_model(r'C:\Users\HP\Desktop\Emotion_Detection_CNN - Copy\model.h5')
